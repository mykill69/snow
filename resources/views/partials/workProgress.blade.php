                                ...
                                <td class="text-center align-middle">
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <button type="button" class="btn btn-default btn-sm edit-btn"
                                            data-toggle="modal" data-target="#editWorkModal"
                                            data-id="{{ $progress->id }}" data-progress="{{ $progress->progress }}"
                                            data-status="{{ $progress->proj_status }}"
                                            style="background-color: #3B8EA5;border-top-left-radius: 4px;border-bottom-left-radius: 4px;">
