    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a href="#" class="nav-link {{ request()->routeIs('ticketReports*') ? 'active' : '' }}"
                ...
                <li>
                    <a href="{{ route('ganttReports') }}"
                        class="dropdown-item {{ request()->routeIs('ganttReports') ? 'active' : '' }}">
                        Gantt Chart Report
                    </a>
                </li>
            </ul>
    ...
    request()->routeIs('taskCalendar')
        ...
        request()->routeIs('taskCalendar')
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('ticketReports') }}"
                        class="nav-link {{ request()->routeIs('ticketReports*') ? 'active' : '' }}">
