<div style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 15px; color: #333; line-height: 1.6; padding: 20px;">
    ...
    <p>
        We would like to inform you that your support ticket has been updated. Below are the updated details of your request:
    </p>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 14px;">
        ...
        @if($ticket->remarks)
        <tr>
            <td style="font-weight: bold; padding: 8px 0;">Action Taken</td>
            <td style="padding: 8px 0;">{{ $ticket->remarks }}</td>
        </tr>
        @endif
